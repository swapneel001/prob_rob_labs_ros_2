...
class EKFOdom(Node):
    ...
    def publish_odom(self, stamp):
        ...
        pose_cov = [0.0] * 36
        pose_cov[0]  = float(self.Sigma[0, 0])
        pose_cov[7]  = float(self.Sigma[1, 1])
        pose_cov[35] = float(self.Sigma[2, 2])
        ...
        twist_cov = [0.0] * 36
        twist_cov[0]  = float(self.Sigma[3, 3])
        twist_cov[35] = float(self.Sigma[4, 4])
